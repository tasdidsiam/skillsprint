function updateProjects(){
  ...
  cards.forEach(card => {
    ...
    const searchMatch = title.includes(value)
  ...
  document.getElementById("noData").classList.toggle("hidden", visibleCount !== 0)
}

function filterProjects(){ updateProjects() }
function searchProjects(){ updateProjects() }

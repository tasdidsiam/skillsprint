...
const titleEl = viewModal.querySelector('h2');
const descEl = viewModal.querySelector('p');
const stackEl = viewModal.querySelectorAll('.bg-white\\/5 p')[0];
const dateEl = viewModal.querySelectorAll('.bg-white\\/5 p')[1];
const liveBtn = viewModal.querySelectorAll('a')[0];
const gitBtn = viewModal.querySelectorAll('a')[1];

const projects = {
  dashboard: {
    title: "React Analytics Dashboard",
    desc: "Modern analytics dashboard with charts, statistics cards and filters.",
    stack: "React, Tailwind, Recharts",
    date: "12 Jan 2026",
    live: "https://demo.skillSprint-dashboard.com",
    git: "https://github.com/skillSprint/react-dashboard"
  },
  landing: {
    title: "Startup Landing Page",
    desc: "High conversion startup landing page with animations and smooth UI.",
    stack: "HTML, Tailwind, JavaScript",
    date: "20 Dec 2025",
    live: "https://demo.skillSprint-landing.com",
    git: "https://github.com/skillSprint/landing-page"
  },
  python: {
    title: "Python Automation Scripts",
    desc: "Automated data processing & reporting workflows using Python.",
    stack: "Python, Automation, Scripting",
    date: "02 Jan 2026",
    live: "https://demo.skillSprint-automation.com",
    git: "https://github.com/skillSprint/python-automation"
  }
};
...
function openViewModal(key){
  ...
  stackEl.innerText = p.stack;
  dateEl.innerText = p.date;
  liveBtn.href = p.live;
  gitBtn.href = p.git;
